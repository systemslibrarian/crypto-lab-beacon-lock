...
> = {
  ...
  "control-boundary|button.btn.btn-quiet.btn-small": { ratio: 2.14, required: 3.0, unverified: false },
  "control-boundary|button.btn.btn-small.btn-quiet": { ratio: 1.94, required: 3.0, unverified: false }
};
